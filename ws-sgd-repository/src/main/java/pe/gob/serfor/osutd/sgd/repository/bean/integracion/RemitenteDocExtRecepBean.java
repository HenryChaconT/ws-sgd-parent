...
public class RemitenteDocExtRecepBean {
	...
	//determina el trámite virtual
	private String ind_origen;
	private Integer n_id_solicitud;
	
	
	public Integer getN_id_solicitud() {
		return n_id_solicitud;
	}

	public void setN_id_solicitud(Integer n_id_solicitud) {
		this.n_id_solicitud = n_id_solicitud;
	}
	...
	public void setInd_origen(String ind_origen) {
		this.ind_origen = ind_origen;
	}
